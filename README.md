...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* INTERACTIVE SECTION & PERSONAGEM */
        .interactive-section {
            margin-top: 25px;
            text-align: center;
        ...
        /* Classe disparada ao clicar no NÃO */
        .waving-no .arm-no {
            animation: waveArm 0.6s ease-in-out;
        }

        .waving-no .head-group {
...
<body>
    ...
    <div class="container">
        ...
        <section class="card">
            ...
            <div class="interactive-section">
                ...
                <!-- PERSONAGEM ANIMADO INTERATIVO -->
                <div class="character-container" id="character">
                    <svg class="character-svg" viewBox="0 0 100 100">
                        <!-- Corpo / Roupinha estilo Coraline -->
                        <path d="M 30,70 Q 50,60 70,70 L 75,100 L 25,100 Z" fill="#facc15" />
                        <!-- Braço Esquerdo -->
                        <path d="M 30,72 Q 18,80 20,95" stroke="#eab308" stroke-width="6" stroke-linecap="round" fill="none" />
                        
                        <!-- Braço Direito (Que faz o Não) -->
                        <g class="arm-no">
                            <path d="M 70,72 Q 82,60 78,42" stroke="#eab308" stroke-width="6" stroke-linecap="round" fill="none" />
                            <!-- Mãozinha com dedo fazendo Não -->
                            <circle cx="78" cy="40" r="4" fill="#fde047" />
                            <path d="M 78,40 L 78,32" stroke="#fde047" stroke-width="3" stroke-linecap="round" />
                        </g>

                        <!-- Cabeça e Rosto -->
                        <g class="head-group" id="headGroup">
                            <circle cx="50" cy="45" r="22" fill="#fde047" />
                            <!-- Cabelo azul clássico estilo Coraline -->
                            <path d="M 26,42 Q 30,20 50,20 Q 70,20 74,42 Q 65,30 50,32 Q 35,30 26,42 Z" fill="#1d4ed8" />
                            
                            <!-- Olhos -->
                            <ellipse cx="42" cy="44" rx="3" ry="4" fill="#0f172a" id="eyeL" />
                            <ellipse cx="58" cy="44" rx="3" ry="4" fill="#0f172a" id="eyeR" />
                            
                            <!-- Bochechas fofas -->
                            <circle cx="37" cy="49" r="3.5" fill="#f43f5e" opacity="0.4" />
                            <circle cx="63" cy="49" r="3.5" fill="#f43f5e" opacity="0.4" />
                            
                            <!-- Boca (Sorriso que muda para "Não") -->
                            <path d="M 44,52 Q 50,57 56,52" stroke="#0f172a" stroke-width="2" fill="none" stroke-linecap="round" id="mouth" />
                        </g>
                    </svg>
                </div>

                <div class="btn-container">
                    <button class="btn-action btn-sim" id="btnSim" onclick="respostaSim()">¡SÍ! ❤️</button>
                    <button class="btn-action btn-nao" id="btnNao" onclick="clicouNao()">NO</button>
                </div>
            </div>
        </section>
    ...
    <script>
        // LÓGICA DE CRESCIMENTO DO BOTÃO SIM E ANIMAÇÃO DO PERSONAGEM
        let escalaSim = 1;
        ...
        function clicouNao() {
            ...
            btnSim.style.padding = `${paddingVertical}px ${paddingHorizontal}px`;
            btnSim.style.fontSize = `${tamanhoFonte}rem`;

            // Muda frase do botão
            indiceFrase = (indiceFrase + 1) % frasesNao.length;
            btnNao.textContent = frasesNao[indiceFrase];

            // Ativa animação do Personagem fazendo o Gesto de NÃO
            character.classList.remove("waving-no");
            void character.offsetWidth; // Trigger reflow
            character.classList.add("waving-no");

            // Muda a boca temporariamente para expressão de "Não/Surpresa"
            mouth.setAttribute("d", "M 46,54 Q 50,50 54,54");

            setTimeout(() => {
                // Volta para o sorriso
                mouth.setAttribute("d", "M 44,52 Q 50,57 56,52");
            }, 800);
        }
